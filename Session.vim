...
silent only
cd /mnt/c/Users/Talha/source/repos/Test/Test
...
badd +1 main.cpp
badd +43 ~/.vimrc
badd +398 SequentialListAllocator.cpp
badd +45 SequentialListAllocator.h
badd +43 AllocatorBenchmark.h
argglobal
silent! argdel *
edit main.cpp
...
exe 'vert 1resize ' . ((&columns * 170 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 40 + 105) / 211)
argglobal
let s:cpo_save=&cpo
set cpo&vim
